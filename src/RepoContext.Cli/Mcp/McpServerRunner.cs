...
public static class McpServerRunner
{
    ...
    public const string Instructions =
        "Start with repoctx_get_context(detail='auto', responseBudgetTokens=2000, ensureFresh=true); auto returns "
        ...
        + "get_related_files for dependencies/impact, trace for an exact ticket key, link, "
        + "symbol or path. Narrow any of them with path. Reuse receipts via seen or session. "
