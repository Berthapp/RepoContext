...
public static class AgentInstructions
{
    ...
    private static string BuildPlaybook() =>
        string.Join('\n',
            ...
            "4. Unfamiliar boundaries: `repoctx architecture --depth 1 --format md`.",
            "5. After editing: `repoctx changed --patch --format md`; if it reports `stale`,",
            "   run `repoctx index` (fast, incremental) and re-query.",
            "6. A knowledge gap `context` left open: `repoctx memory search \"<topic>\"",
            ...
            "7. Optional orientation for a new, unfamiliar repository: `repoctx prime`. Use it",
            ...
            "8. Stop querying once no evidence needed for the task is missing.",
            string.Empty,
